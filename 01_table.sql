...
passwd     varchar(20)    not null   (반드시 값을 넣어얗 하는 컬럼.)
...
insert into member values ('my-id3', '3333', '유관순', 20000, '2022-05-24'); -- 전체 컬럼에 값을 모두 넣을 경우 컬럼 지정을 생략할 수 있다.
insert into member values ('my-id4', '4444', '권혁준', 30000, '2022-05-24');
insert into member values ('my-id5', '5555', '장영실', 40000, '2022-05-24');
